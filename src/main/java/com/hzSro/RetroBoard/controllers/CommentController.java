package com.hzSro.RetroBoard.controllers;
...
import com.hzSro.RetroBoard.domain.CommentType;
import com.hzSro.RetroBoard.services.CommentService;
...
public class CommentController {
    ...
    public String createComment(@RequestParam(name = "plusComment", required = false) String plusComment,
            ...
            @RequestParam(name = "startComment", required = false) String starComment) {
